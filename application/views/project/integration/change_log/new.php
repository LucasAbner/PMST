<div id="page-wrapper">
            ...
            <form method="POST" action="<?php echo base_url() ?>change_log/insert/">
                ...
                <div class=" col-lg-4 form-group">
                    ...
                    <a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right"
                       title="<?= $this->lang->line('change_log-requester-tooltip') ?>"><i
                                class="glyphicon glyphicon-comment"></i></a>

                    <button type="button" class="btn btn-info" style="background-color: #23272b;
            color: white; " data-toggle="modal" data-target="#myModal">Attach file
                    </button>
                ...
                <div class="col-lg-6 form-group">
                    ...
                    <a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right"
                       title="<?= $this->lang->line('tep-request_date-tooltip') ?>"><i
                                class="glyphicon glyphicon-comment"></i></a>
                    <div class="input-group">
                        <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                        </div>
                        <input class="form-control" id="request_date" placeholder="YYYY/MM/DD" type="text"
                               name="request_date"/>
                    </div>
                </div>
                ...
                <div class=" col-lg-4 form-group">
                    ...
                    <a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right"
                       title="<?= $this->lang->line('change_log-change_type-tooltip') ?>"><i
                                class="glyphicon glyphicon-comment"></i></a>
                ...
                <div class=" col-lg-4 form-group">
                    ...
                    <a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right"
                       title="<?= $this->lang->line('change_log-situation-tooltip') ?>"><i
                                class="glyphicon glyphicon-comment"></i></a>
                ...
                <div class=" col-lg-10 form-group">
                    ...
                    <a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right"
                       title="<?= $this->lang->line('change_log-change_description-tooltip') ?>"><i
                                class="glyphicon glyphicon-comment"></i></a>

                    <textarea oninput="eylem(this, this.value)" class="form-control elasticteste" type="text"
                              id="change_description" name="change_description" maxlength="255"></textarea>
                ...
                <div class=" col-lg-10 form-group">
                    ...
                    <a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right"
                       title="<?= $this->lang->line('change_log-project_management_feedback-tooltip') ?>"><i
                                class="glyphicon glyphicon-comment"></i></a>

                    <textarea oninput="eylem(this, this.value)" class="form-control elasticteste" type="text"
                              id="project_management_feedback" name="project_management_feedback"
                ...
                <div class=" col-lg-10 form-group">
                    ...
                    <a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right"
                       title="<?= $this->lang->line('change_log-ccc_feedback-tooltip') ?>"><i
                                class="glyphicon glyphicon-comment"></i></a>

                    <textarea oninput="eylem(this, this.value)" class="form-control elasticteste" type="text"
                              id="ccc_feedback" name="ccc_feedback" maxlength="255"></textarea>
                </div>
                ...
                <div class="col-lg-6 form-group">
                    ...
                    <a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right"
                       title="<?= $this->lang->line('tep-ccc_feedback_date-tooltip') ?>"><i
                                class="glyphicon glyphicon-comment"></i></a>
                    <div class="input-group">
                        <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                        </div>
                        <input class="form-control" id="ccc_feedback_date" placeholder="YYYY/MM/DD" type="text"
                               name="ccc_feedback_date"/>
                    </div>
                </div>
                ...
                <div class=" col-lg-10 form-group">
                    ...
                    <a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right"
                       title="<?= $this->lang->line('change_log-comments-tooltip') ?>"><i
                                class="glyphicon glyphicon-comment"></i></a>
                ...
                <div class="col-lg-10">
                    <button id="new_change_log-submit" type="submit" value="Save"
    ...
    <div class="modal fade" id="myModal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form id="formModal" action="<?= base_url() ?>change_log/addAttach/" method="post" enctype='multipart/form-data'>
    ...
    <script type="text/javascript">
        ...
        /*
                $("#forModal").submit(function(e) {
                    var url = (abrir e fechar php) base_url()"change_log/addAttach/";
            $.ajax({
                type: "POST",
                url: url,
